...
namespace Hackathon.SpotBot
{
    public class DispatchBot : ActivityHandler
    {
        ...
        {
            // First, we use the dispatch model to determine which cognitive service (LUIS) to use.
        ...
        private async Task DispatchToTopIntentAsync(ITurnContext<IMessageActivity> turnContext, string intent, RecognizerResult recognizerResult, CancellationToken cancellationToken)
        {
            ...
            {
                case "i_spotbot":
                    await ProcessSpotBot(turnContext, recognizerResult.Properties["luisResult"] as LuisResult, cancellationToken);
                    break;
                default:
        ...
        private async Task ProcessSpotBot(ITurnContext<IMessageActivity> turnContext, LuisResult luisResult, CancellationToken cancellationToken)
        {
            _logger.LogInformation("ProcessOrderDetailQueriesAsync");
